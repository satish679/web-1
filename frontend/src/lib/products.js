...
export const TESTIMONIALS = [
    {
        quote: "Good quality service. Print follow up and delivery by staffs.",
        author: "Gowtham Subramanian",
        role: "Google Review",
    },
    {
        quote:
            "Provided good customer service and staff are very attentive. The products made my dream home look elegant. Will refer my friends.",
        author: "Govindaraju P",
        role: "Google Review",
    },
    {
        quote:
            "They were very obliging. Understood our requirement and completed the curtains work to our satisfaction in time.",
        author: "Vishnu",
        role: "Google Review",
    },
    {
        quote:
            "Wow Atmosphere, excellent collection. BK team are very friendly. Happy with your product.",
        author: "Alagu Raja",
        role: "Google Review",
    },
];
