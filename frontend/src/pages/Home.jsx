...
export default function Home() {
    return (
        <div>
            ...
            {/* ---------- STATS ---------- */}
            <section className="relative py-24 md:py-28 bg-matte text-ivory overflow-hidden" data-testid="home-stats">
                <div className="absolute inset-0">
                    <LuxImg name="room-living" alt="" className="w-full h-full object-cover opacity-30" />
                </div>
                <div className="absolute inset-0 bg-matte/70" />
                <div className="max-w-[1440px] mx-auto px-6 md:px-10 relative grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8 text-center">
                    {[
                        { n: "12K", l: "Happy Customers" },
                        { n: "20+", l: "Total Products" },
                        { n: "30+", l: "Brands" },
                        { n: "27+", l: "Years Experience" },
                    ].map((s, i) => (
                        <Reveal key={s.l} delay={i * 100}>
                            <p className="font-serif text-4xl md:text-6xl text-champagne">{s.n}</p>
                            <p className="mt-2 overline !text-ivory/70">{s.l}</p>
                        </Reveal>
                    ))}
                </div>
            </section>
