...
const SHOWROOM_COUNT = 37; // showroom-1.jpg ... showroom-37.jpg — see backend/static/img/generated/
const WORK_COUNTS = { curtains: 10, blinds: 8, wallpaper: 6, vertical: 4, zebra: 4, roller: 4 };
const WORK_IMAGES = Object.entries(WORK_COUNTS).flatMap(([cat, count]) =>
    Array.from({ length: count }, (_, i) => `work-${cat}-${i + 1}`)
);
const IMAGES = [
    ...Array.from({ length: SHOWROOM_COUNT }, (_, i) => `showroom-${i + 1}`),
    ...WORK_IMAGES,
    "hero-living", "room-bedroom", "room-dining", "cat-carpets", "cat-flooring",
